...
3. Klicka på **Undantag**. För varje typ av hot anger du ett användarkonto eller en IP-adress som ska uteslutas från identifieringen av dessa hot och klickar på *plustecknet*. Fältet Lägg till entitet (användare eller dator) är sökbart och fylls i automatiskt med entiteter i ditt nätverk.
