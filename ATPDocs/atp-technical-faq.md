...
Den här artikeln innehåller en lista över vanliga frågor och svar om Azure ATP uppdelad i följande catergories: 
- [Vad är Azure ATP](#What-is-Azure-ATP)
- [Licensiering och sekretess](#Licensing-and-privacy)
- [Distribution](#Deployment)
- [Åtgärder](#Operations)
- [Felsökning](#Troubleshooting)

## <a name="what-is-azure-atp"></a>Vad är Azure ATP?
...
## <a name="licensing-and-privacy"></a>Licensiering och sekretess 
...
3.  Kör följande kommando: nslookup -<DC iP address>
    -   Tryck på RETUR
    -   Typ: Är -d <FQDN>
    -   Beroende på hur din miljö varierar svar från ”fråga nekade” till en lista över dina DNS-poster. 
...
- [Felsökning](troubleshooting-atp-known-issues.md)
